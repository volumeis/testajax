...
public class UserController {
	...
	public void addJsonUser( @RequestBody User user, Model model ) throws Exception {
		...
		System.out.println("/user/addJsonUser : POST");
		//Business Logic
		userService.addUser(user);
	...
	@RequestMapping( value="updateJsonUser", method=RequestMethod.POST )
	public void updatezJsonUser( @RequestBody User user , Model model , HttpSession session) throws Exception{
		
		System.out.println("/user/updateJsonUser : POST");
		//Business Logic
		userService.updateUser(user);
...
//		}
	...
	@RequestMapping( value="listJsonUser" )
	public void listJsonUser( @RequestBody Search search, Model model ) throws Exception{
		
		System.out.println("/user/listJsonUser : GET / POST");
